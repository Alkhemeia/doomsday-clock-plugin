...
You can change the color of the clock using the widget or the shortcode.
...
== 3rd Party Services ==
The plugin reads the current time from: <a href="https://thebulletin.org/doomsday-clock/">https://thebulletin.org</a>
...
color=#e1e1e1 (any hexadecimal color code)
Example code:  [doomsday color=#e1e1e1]
